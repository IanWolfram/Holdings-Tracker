...
## Corpus Check
- 263 files · ~155,522 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 825 nodes · 1483 edges · 47 communities detected
...
Cohesion: 0.03
Nodes (9): ClassifierService, fetchFullArticleContent(), isPublicHttpUrl(), getHistory(), startPolygonFetch(), glowClass(), PositionCard(), getVaultStoriesForTicker() (+1 more)
...
Cohesion: 0.04
Nodes (15): buildOAuth(), getAccessToken(), getRequestToken(), toHeader(), getServices(), getServicesForUser(), touchUserServices(), wire() (+7 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (14): classifyNews(), findInVault(), keywordClassify(), FsVaultStore, reconstructMarkdown(), serializeFrontmatter(), splitFrontmatter(), SupabaseVaultStore (+6 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (4): DiskCache, ETradeProvider, MapCache, PortfolioService
...
Cohesion: 0.12
Nodes (8): CountryFocusPanel(), flagEmoji(), formatCurrency(), formatGainLoss(), calculateSentimentMetrics(), clamp01(), normalizeConfidence(), verdictToPolarity()

### Community 14 - "Community 14"
Cohesion: 0.17
Nodes (15): buildTickerKnowledge(), getRecentVaultStories(), getSubagentPrompt(), parseFrontmatter(), runLearningPass(), runMetaReflection(), updateTickerKnowledgeFile(), appendVaultLog() (+7 more)
...
Cohesion: 0.23
Nodes (10): buildSummary(), classifyRegime(), fetchSeriesSample(), getMacroSnapshot(), round(), snapshotWithoutKey(), trend(), wowChange() (+2 more)
...
Cohesion: 0.22
Nodes (2): getOrInitTickerAnalysis(), getTickerAnalysisProgress()
...
Cohesion: 0.53
Nodes (4): fetchCrumb(), fetchYahooHistory(), getCrumb(), makeCrumbRateLimitedError()
...
## Knowledge Gaps
- **Thin community `Community 36`** (2 nodes): `instrumentation.node.ts`, `register()`
...
- **Thin community `Community 38`** (2 nodes): `FinnhubBadge.tsx`, `FinnhubBadge()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (2 nodes): `flag-emoji.ts`, `flagEmoji()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (1 nodes): `electron-builder.config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 43`** (1 nodes): `next.config.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (1 nodes): `PolygonBadge.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (1 nodes): `modePreload.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (1 nodes): `licensePreload.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `NewsService` connect `Community 23` to `Community 0`?**
