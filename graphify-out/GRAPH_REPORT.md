...
## Corpus Check
- 215 files · ~189,785 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 773 nodes · 1379 edges · 42 communities detected
...
Cohesion: 0.04
Nodes (21): detectTickers(), handler(), readLatestDailySummary(), readLatestMacroSnapshot(), readRecentInsights(), readRecentVaultNews(), FinnhubProvider, MapCache (+13 more)
...
Cohesion: 0.04
Nodes (9): handleCancel(), handleKeyDown(), handleSubmit(), fallbackProfile(), fetchCompanyProfile(), normalizeKey(), resolveCoordinates(), newConversation() (+1 more)
...
Cohesion: 0.11
Nodes (5): ETradeProvider, PortfolioService, enrichWithCompanyNames(), enrichWithHistory(), handler()
...
Cohesion: 0.13
Nodes (16): aggregateTickerBuyCountsLast30Days(), buildContradictionAlertContent(), detectClusteringAnomalies(), detectContradictions(), meanAbsCorrelationToPortfolio(), readSubagentPrompt(), resolveContradictionWithMetaAnalyst(), runAlertsPass() (+8 more)
...
Cohesion: 0.17
Nodes (12): fetchFullArticleContent(), isPublicHttpUrl(), fetchUserPositions(), formatNumber(), getOrInitTickerAnalysis(), getTickerAnalysisProgress(), runForecast(), runStockAgent() (+4 more)
...
Cohesion: 0.22
Nodes (15): buildTickerKnowledge(), getRecentVaultStories(), getSubagentPrompt(), parseFrontmatter(), runLearningPass(), runMetaReflection(), updateTickerKnowledgeFile(), buildSummary() (+7 more)
...
- **Why does `NewsService` connect `Community 23` to `Community 3`?**
