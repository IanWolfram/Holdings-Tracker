  ...
  return (
    <AnimatePresence initial={false}>
      {hovered && (
        ...
        >
          {compact ? (
            // ---------- COMPACT: reasoning only, with dark background container ----------
            <div className="mt-[6px]">
              ...
              >
                {activeReason ? (
                  <p className="text-[10px] text-slate-400 leading-[1.4] m-0">
                    {activeReason}
                  </p>
                ) : (
                ...
                {activeIsAnalyzed && (
                  <div className="mt-1.5 flex items-center gap-1.5">
                    <span className="text-[7.5px] font-black bg-white/10 text-white px-1 py-[1px] rounded-[2px] tracking-tight">
                      M5 VERIFIED
                    </span>
                  </div>
                )}
