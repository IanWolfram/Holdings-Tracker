  ...
  BR: [
    {
      ...
      url: "#", verdict: "BUY", confidence: 0.91, reason: "Earnings beat with raised guidance is a clear bullish signal.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "BUY", confidence: 0.78, reason: "Multiple analyst upgrades reinforce bullish momentum.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "BUY", confidence: 0.83, reason: "New partnership adds meaningful recurring revenue.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "HOLD", confidence: 0.61, reason: "Sector-wide regulatory risk without BR-specific allegations.", classifiedAt: new Date().toISOString(),
    },
  ],
  ...
  GLD: [
    {
      ...
      url: "#", verdict: "BUY", confidence: 0.88, reason: "Rate pause expectations are directly bullish for gold.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "BUY", confidence: 0.85, reason: "Record central bank buying is a structural tailwind for gold prices.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "SELL", confidence: 0.72, reason: "Dollar strength is a near-term headwind for gold.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "BUY", confidence: 0.80, reason: "Large institutional inflows signal strong demand.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "BUY", confidence: 0.74, reason: "Safe-haven demand supports gold during geopolitical uncertainty.", classifiedAt: new Date().toISOString(),
    },
  ],
  ...
  MSFT: [
    {
      ...
      url: "#", verdict: "BUY", confidence: 0.94, reason: "Azure acceleration with AI tailwinds exceeds consensus expectations.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "BUY", confidence: 0.89, reason: "Record Copilot adoption demonstrates strong AI monetization.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "SELL", confidence: 0.67, reason: "Regulatory action could force product unbundling and revenue impact.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "BUY", confidence: 0.82, reason: "Capital return program signals management confidence in cash flow.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "HOLD", confidence: 0.58, reason: "Neutral — consensus already reflects current price action.", classifiedAt: new Date().toISOString(),
    },
  ],
  ...
  RBL: [
    {
      ...
      url: "#", verdict: "HOLD", confidence: 0.55, reason: "Strategic review is neutral until outcome is known.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "SELL", confidence: 0.76, reason: "Revenue miss with weak guidance warrants caution.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "BUY", confidence: 0.79, reason: "User growth in older demographics signals monetization opportunity.", classifiedAt: new Date().toISOString(),
    },
  ],
  ...
  RPI: [
    {
      ...
      url: "#", verdict: "BUY", confidence: 0.70, reason: "Lower inflation benefits RPI-linked instruments through real yield compression.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "BUY", confidence: 0.66, reason: "Positive real yields improve the investment case for RPI instruments.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "HOLD", confidence: 0.60, reason: "Rate hold is broadly neutral for inflation-linked assets.", classifiedAt: new Date().toISOString(),
    },
  ],
  ...
  RXD: [
    {
      ...
      url: "#", verdict: "BUY", confidence: 0.73, reason: "Sector weakness benefits inverse healthcare ETFs like RXD.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "BUY", confidence: 0.81, reason: "High volume in inverse ETF confirms bearish healthcare momentum.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "SELL", confidence: 0.77, reason: "Healthcare recovery directly hurts inverse ETF performance.", classifiedAt: new Date().toISOString(),
    },
    {
      ...
      url: "#", verdict: "SELL", confidence: 0.69, reason: "Reduced reform risk is bearish for inverse healthcare ETF.", classifiedAt: new Date().toISOString(),
    },
  ],
};
